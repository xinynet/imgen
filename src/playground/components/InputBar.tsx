...
export default function InputBar() {
  ...
  const selectClass = 'px-3 py-1.5 rounded-xl border border-gray-200/60 dark:border-white/[0.08] bg-white/50 dark:bg-white/[0.03] hover:bg-white dark:hover:bg-white/[0.06] text-xs text-gray-800 dark:text-gray-200 transition-all duration-200 shadow-sm'
  ...
  const renderParams = (cols: string) => (
    <div className={`grid ${cols} gap-2 text-xs flex-1`}>
      ...
      >
        <span className="text-gray-600 dark:text-gray-400 ml-1">尺寸</span>
        <button
          type="button"
          onClick={() => { dismissAllTooltips(); setShowSizePicker(true) }}
          className="px-3 py-1.5 rounded-xl border border-gray-200/60 dark:border-white/[0.08] bg-white/50 dark:bg-white/[0.03] hover:bg-white dark:hover:bg-white/[0.06] focus:outline-none text-xs text-left text-gray-800 dark:text-gray-200 transition-all duration-200 shadow-sm font-mono"
          title="选择尺寸"
        >
          {displaySize}
        </button>
      ...
      >
        <span className="text-gray-600 dark:text-gray-400 ml-1">质量</span>
        <Select
      ...
      <label className="flex flex-col gap-0.5">
        <span className="text-gray-600 dark:text-gray-400 ml-1">格式</span>
        <Select
      ...
      >
        <span className="text-gray-600 dark:text-gray-400 ml-1">压缩率</span>
        <input
          ...
          max={100}
          placeholder="0-100"
          className={`px-3 py-1.5 rounded-xl border border-gray-200/60 dark:border-white/[0.08] focus:outline-none text-xs text-gray-800 dark:text-gray-200 transition-all duration-200 shadow-sm ${
            compressionDisabled
      ...
      >
        <span className="text-gray-600 dark:text-gray-400 ml-1">审核</span>
        <Select
      ...
      <label className="relative flex flex-col gap-0.5">
        <span className="text-gray-600 dark:text-gray-400 ml-1">数量</span>
        <input
          value={nInput}
          ...
          className="px-3 py-1.5 rounded-xl border border-gray-200/60 dark:border-white/[0.08] bg-white/50 dark:bg-white/[0.03] focus:outline-none text-xs text-gray-800 dark:text-gray-200 transition-all duration-200 shadow-sm"
        />
